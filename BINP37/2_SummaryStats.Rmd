...
# this leaves us with 16062 events from 482 genes 
...
# Save plot 1 as PDF
ggsave("CEvIR_distribution.pdf", plot = plot1, device = "pdf")
...
# Save plot 2 as PDF
ggsave("AAvAD_distribution.pdf", plot = plot2, device = "pdf")
...
# Patient age 
filtered_patient_data %>%
  group_by(`Age (5-year range, e.g., 35(31-35), 40(36-40), 45(41-45) etc.)`) %>%
  count()
```
